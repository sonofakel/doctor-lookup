...
$(document).ready(function() {
  $('#doc-name-form').submit(function() {
    ...
    let promise = new Promise(function(resolve, reject) {
      ...
      let url = `https://api.betterdoctor.com/2016-03-01/doctors?name=${docName}&location=47.6129432%2C-122.4821474%2C25&user_location=47.6129432%2C-122.4821474&skip=0&limit=25&user_key=${apiKey}`;
